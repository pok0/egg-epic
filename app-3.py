...
st.caption(
    ...
    "Egg detection: brown HSV colour-blob segmentation (primary) + grayscale CLAHE-Canny (fallback). "
    "Coin detection: size-bounded Hough circles (max radius = 11 % of frame, eliminates background lights/objects) "
    "with egg-region exclusion and HSV ring classification. "
